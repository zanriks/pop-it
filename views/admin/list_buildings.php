    ...
    <?php if (!empty($buildings)): ?>
        <?php foreach ($buildings as $building): ?>
            <div class="table-row">
                ...
                <div class="actions">
                    <a href="/admin/building/edit?buildingId=<?= $building->buildingId ?>" style="color: #1c6d7a;">Редактироваь</a>
                    <a href="/admin/building/delete?buildingId=<?= $building->buildingId ?>"
                       onclick="return confirm('Удалить здание?')" style="color: red;">Удаплить</a>
                </div>
            </div>
        <?php endforeach; ?>
    <?php else: ?>
